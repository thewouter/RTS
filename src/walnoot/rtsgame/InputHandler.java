...
public class InputHandler implements KeyListener, MouseListener, MouseMotionListener, MouseWheelListener {
	...
	public Key dot = new Key (".", KeyEvent.VK_PERIOD, KeyEvent.VK_SEPARATOR);
	public Key lessThan = new Key ("<", KeyEvent.VK_LESS);
	public Key moreThan = new Key (">", KeyEvent.VK_GREATER);
	public Key comma = new Key (",", KeyEvent.VK_COMMA);
