...
public class TentIIIStructure extends BasicStructure {
	...
	public TentIIIStructure(Map map, GameScreen screen, int xPos, int yPos, Direction front){
		super(map, screen, xPos, yPos,  0, 0,ID, front);
	}
	
	public TentIIIStructure(Map map, GameScreen screen ,int xPos, int yPos, int health, Direction front){
		super(map,screen,xPos,yPos, 0, 0, ID, front);
		this.health = health;
	}
