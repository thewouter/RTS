...
public class Images {
	public static BufferedImage[][] terrain = split(load("/res/Pictures/terrain3.png"), 16, 16);
	...
	public static BufferedImage[][] flag = split(load("/res/Pictures/animations/MoveFlag.png"),6,1);
	...
	public static BufferedImage[][] smallButtons = split(load("/res/Pictures/8x8buttons.png"),10,10);
